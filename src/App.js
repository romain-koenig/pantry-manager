  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <footer>
          Fait avec <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-heart" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z"/>
          <path d="M12 20l-7 -7a4 4 0 0 1 6.5 -6a.9 .9 0 0 0 1 0a4 4 0 0 1 6.5 6l-7 7" />
        </svg> par <a href="https://kromatic.fr" target="_blank"
            rel="noopener noreferrer">Kromatic</a>.<br />
    Code à retrouver sur <a href="https://github.com/romain-koenig/pantry-manager" target="_blank" rel="noopener noreferrer">GitHub</a>. <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
    <path stroke="none" d="M0 0h24v24H0z"/>
