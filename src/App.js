  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <footer>
          Fait avec <Heart size={24} strokeWidth={2} color={'#bf4040'} /> par <a href="https://kromatic.fr" target="_blank"
            rel="noopener noreferrer">Kromatic</a>.<br />
    Code à retrouver sur <a href="https://github.com/romain-koenig/pantry-manager" target="_blank" rel="noopener noreferrer">GitHub</a>. <BrandGithub
    size={24}
    strokeWidth={2}
    color={'black'}
  />
