...
class ProductsBadges extends Component {
  ...
  render() {
    ...
    const productsToBuy = Object.keys(this.props.products).reduce((acc, key) =>
      acc + (this.props.products[key].quantity < this.props.products[key].desiredQuantity ?
        this.props.products[key].desiredQuantity - this.props.products[key].quantity :
        0)
      , 0);
